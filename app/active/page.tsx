    ...
    const load = async () => {
      ...
      try {
        ...
        if (mounted) {
          ...
          // fallback to empty arrays (you may keep mock data if preferred)
          setBorrows([]);
          setReservations([]);
          setHistory([]);
        }
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <div className="mb-8 animate-fadeIn">
          ...
          <p className="text-muted-foreground">
            Manage your borrows, reservations, and reading history
          </p>
        </div>
            ...
            {borrows.length > 0 ? (
              borrows.map((borrow) => {
                ...
                return (
                  <Card
                    key={borrow.id}
                    className="p-6 border-border hover:border-primary transition-smooth"
                  >
