...
export default function AdminPage() {
  ...
  const alerts = [
    { type: "warning", title: "High Demand", description: "Project Hail Mary: 8 reservations, only 3 copies" },
    { type: "alert", title: "Late Returns", description: "5 users have overdue books beyond grace period" },
    { type: "info", title: "Low Stock", description: "6 books below recommended inventory levels" },
  ]
  ...
  const stats = [
    { icon: BookOpen, label: "Active Borrows", value: activeBorrows.toString(), change: "+12 this week" },
    { icon: Users, label: "Total Users", value: "995", change: "+8 new" },
    { icon: Clock, label: "Avg. Borrow Duration", value: "16.2 days", change: "Stable" },
    { icon: TrendingUp, label: "Reservations", value: activeReservations.toString(), change: "Active now" },
  ]
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8 animate-fadeIn">
          ...
          <p className="text-muted-foreground">System overview, analytics, and operational intelligence</p>
        </div>
        ...
        <div className="mb-8 space-y-3">
          {alerts.map((alert, index) => (
            <Card key={index} className="p-4 border-border flex items-start gap-3 animate-slideIn">
              <AlertCircle
        ...
        <Tabs defaultValue="borrowing" className="w-full">
          ...
          <TabsContent value="borrowing" className="space-y-6 mt-6">
            <Card className="p-6 border-border animate-fadeIn">
              <h3 className="text-lg font-semibold mb-4">Borrowing Activity (6 months)</h3>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border">
                      ...
                      <th className="text-center py-3 px-4 font-semibold">Demand</th>
                    </tr>
                  </thead>
                  <tbody>
                    {topBooks.map((book) => (
                      <tr key={book.id} className="border-b border-border hover:bg-muted/30 transition-colors">
                        ...
                        <td className="text-right py-3 px-4 font-semibold">{book.borrows}</td>
          ...
          <TabsContent value="inventory" className="space-y-6 mt-6">
            <div className="grid lg:grid-cols-2 gap-6">
              <Card className="p-6 border-border animate-fadeIn">
                <h3 className="text-lg font-semibold mb-4">Borrowing by Genre</h3>
                <div className="h-[300px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie
                ...
                <div className="space-y-6">
                  <div>
                    <div className="flex justify-between mb-2">
                      <span className="text-sm font-semibold">Well Stocked (&gt;70%)</span>
                      <span className="text-sm text-success font-bold">89 books</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      <span className="text-sm font-semibold">Moderate (30-70%)</span>
                      <span className="text-sm text-amber-500 font-bold">34 books</span>
                    </div>
                    <div className="w-full bg-muted rounded-full h-3 overflow-hidden">
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      <span className="text-sm font-semibold">Low Stock (&lt;30%)</span>
                      <span className="text-sm text-destructive font-bold">6 books</span>
                    </div>
                    <div className="w-full bg-muted rounded-full h-3 overflow-hidden">
                  ...
                  <div className="pt-4 border-t border-border">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="p-3 bg-muted/30 rounded-lg">
                        ...
                        <p className="text-2xl font-bold">{books.reduce((acc, b) => acc + b.totalCopies, 0)}</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <TabsContent value="users" className="space-y-6 mt-6">
            <Card className="p-6 border-border animate-fadeIn">
              <h3 className="text-lg font-semibold mb-4">User Distribution by Level</h3>
              <div className="h-[300px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={userStats} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
                    ...
                    />
                    <Legend />
                    <Bar dataKey="count" fill={COLORS.primary} name="Total Users" radius={[4, 4, 0, 0]} />
                    <Bar dataKey="activeUsers" fill={COLORS.success} name="Active Users" radius={[4, 4, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </Card>
            ...
            <Card className="p-6 border-border animate-fadeIn" style={{ animationDelay: "100ms" }}>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="p-4 bg-gradient-to-br from-success/10 to-success/5 rounded-lg border border-success/20">
                  <p className="text-sm text-muted-foreground mb-2">On-time Return Rate</p>
