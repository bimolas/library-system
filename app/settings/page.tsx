...
import { Bell, Lock, SettingsIcon, LogOut, Camera, User, Mail, Save } from "lucide-react"
...
export default function SettingsPage() {
  ...
  const [profileImage, setProfileImage] = useState(mockCurrentUser.profileImage || "/profile-avatar.png")
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <Tabs defaultValue="profile" className="w-full">
          <TabsList className="grid w-full md:w-auto grid-cols-4 bg-muted/30">
            <TabsTrigger value="profile" className="gap-2 hover-lift transition-smooth">
              <User className="w-4 h-4" />
              <span className="hidden sm:inline">Profile</span>
            </TabsTrigger>
            <TabsTrigger value="notifications" className="gap-2 hover-lift transition-smooth">
              <Bell className="w-4 h-4" />
              <span className="hidden sm:inline">Alerts</span>
            </TabsTrigger>
            <TabsTrigger value="privacy" className="gap-2 hover-lift transition-smooth">
              <Lock className="w-4 h-4" />
              <span className="hidden sm:inline">Privacy</span>
            </TabsTrigger>
            <TabsTrigger value="account" className="gap-2 hover-lift transition-smooth">
          ...
          {/* Profile Tab */}
          <TabsContent value="profile" className="mt-6 space-y-4 animate-fadeIn">
            <Card className="p-6 border-border hover-border transition-smooth">
              ...
              <div className="flex flex-col items-center gap-4 mb-6 pb-6 border-b border-border">
                ...
                <p className="text-sm text-muted-foreground">Click camera icon to update photo</p>
              </div>
              ...
              <Button onClick={handleSaveProfile} className="w-full mt-6 gap-2 hover-lift hover-glow transition-smooth">
          ...
          {/* Notifications Tab */}
          <TabsContent value="notifications" className="mt-6 space-y-4 animate-fadeIn">
            <Card className="p-6 border-border hover-border transition-smooth">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg border border-border hover-border transition-smooth">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">When a reserved book becomes available</p>
                  </div>
                  <Switch
                    checked={notifications.bookAvailable}
                    onCheckedChange={(checked) => setNotifications((prev) => ({ ...prev, bookAvailable: checked }))}
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg border border-border hover-border transition-smooth">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">3 days before your book is due</p>
                  </div>
                  <Switch
                    checked={notifications.dueDateReminder}
                    onCheckedChange={(checked) => setNotifications((prev) => ({ ...prev, dueDateReminder: checked }))}
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg border border-border hover-border transition-smooth">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Personalized book suggestions</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg border border-border hover-border transition-smooth">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">When friends borrow or review books</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg border border-border hover-border transition-smooth">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Changes to your reading score and level</p>
                  </div>
                  <Switch
          ...
          {/* Privacy Tab */}
          <TabsContent value="privacy" className="mt-6 space-y-4 animate-fadeIn">
            <Card className="p-6 border-border hover-border transition-smooth">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg border border-border hover-border transition-smooth">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Show your reading history to other members</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg border border-border hover-border transition-smooth">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Receive updates via email in addition to in-app</p>
                  </div>
                  <Switch
              ...
              <Button onClick={handleSavePrivacy} className="w-full mt-6 gap-2 hover-lift hover-glow transition-smooth">
                <Save className="w-4 h-4" />
            ...
            <Card className="p-6 border-border hover-border transition-smooth">
              ...
              <p className="text-sm text-muted-foreground mb-4">Download your reading history and data</p>
          ...
          {/* Account Tab */}
          <TabsContent value="account" className="mt-6 space-y-4 animate-fadeIn">
            {/* Password */}
            <Card className="p-6 border-border hover-border transition-smooth">
            ...
            <Card className="p-6 border-destructive/30 bg-destructive/5 hover:border-destructive/50 transition-smooth">
              ...
              <p className="text-sm text-muted-foreground mb-4">Be careful! These actions cannot be undone.</p>
      ...
      <ConfirmationModal
        ...
        message="You will be logged out from all your active sessions. You'll need to log in again on each device."
